...
$config['tables']['zone_master']  = 'zone_master';
$config['tables']['surname_master']  = 'surname_master';
...
$config['min_password_length']        = 3;                   // Minimum Required Length of Password (not enforced by lib - see note above)
